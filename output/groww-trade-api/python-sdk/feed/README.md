...
## [Feed Client](https://groww.in/trade-api/docs/python-sdk/feed#feed-client)
...
## [Feed Methods](https://groww.in/trade-api/docs/python-sdk/feed#feed-methods)
...
## [Live Data](https://groww.in/trade-api/docs/python-sdk/feed#live-data)
Subscribe and get the live data of equity, index and derivatives.
### [Live Data for Equity and Derivatives](https://groww.in/trade-api/docs/python-sdk/feed#live-data-for-equity-and-derivatives)
...
### [Live Data for Equity and Derivatives - Request Fields](https://groww.in/trade-api/docs/python-sdk/feed#live-data-for-equity-and-derivatives---request-fields)
Name | Type | Description
---|---|---
exchange | str | [Stock Exchange](https://groww.in/trade-api/docs/python-sdk/annexures#exchange)
segment | str |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
exchange_token | str | Exchange token of the equity or derivative as provided in instrument csv.
### [Output](https://groww.in/trade-api/docs/python-sdk/feed#output)
```
{
  "ltp": {
    "NSE": {
...
### [Live Data for Equity and Derivatives - Response Fields](https://groww.in/trade-api/docs/python-sdk/feed#live-data-for-equity-and-derivatives---response-fields)
Name | Type | Description
---|---|---
tsInMillis | int | Epoch time in milliseconds.
ltp | float | The last traded price of the instrument.
## [Indices Live Data](https://groww.in/trade-api/docs/python-sdk/feed#indices-live-data)
...
### [Live Index Data - Request Fields](https://groww.in/trade-api/docs/python-sdk/feed#live-index-data---request-fields)
Name | Type | Description
---|---|---
exchange | str | [Stock Exchange](https://groww.in/trade-api/docs/python-sdk/annexures#exchange)
segment | str |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
exchange_token | str | Exchange token of the equity or derivative as provided in instrument csv.
### [Output](https://groww.in/trade-api/docs/python-sdk/feed#output-1)
```
{
  "NSE": {
    "CASH": {
...
### [Live Index Data - Response Fields](https://groww.in/trade-api/docs/python-sdk/feed#live-index-data---response-fields)
Name | Type | Description
---|---|---
tsInMillis | int | Epoch time in milliseconds.
value | float | The current value of the index.
## [Market Depth](https://groww.in/trade-api/docs/python-sdk/feed#market-depth)
Subscribe and get the live data of equity, index and derivatives.
### [Market Depth for Equity and Derivatives](https://groww.in/trade-api/docs/python-sdk/feed#market-depth-for-equity-and-derivatives)
...
### [Market Depth - Request Fields](https://groww.in/trade-api/docs/python-sdk/feed#market-depth---request-fields)
Name | Type | Description
---|---|---
exchange | str | [Stock Exchange](https://groww.in/trade-api/docs/python-sdk/annexures#exchange)
segment | str |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
exchange_token | str | Exchange token of the equity or derivative as provided in instrument csv.
### [Output](https://groww.in/trade-api/docs/python-sdk/feed#output-2)
```
{
  "NSE": {
    "CASH": {
...
### [Market Depth - Response Fields](https://groww.in/trade-api/docs/python-sdk/feed#market-depth---response-fields)
Name | Type | Description
---|---|---
tsInMillis | int | Epoch time in milliseconds.
...
## [Order Updates](https://groww.in/trade-api/docs/python-sdk/feed#order-updates)
Subscribe and get the latest updates on execution of orders for both equity and derivatives.
### [Derivatives order updates](https://groww.in/trade-api/docs/python-sdk/feed#derivatives-order-updates)
...
### [Output](https://groww.in/trade-api/docs/python-sdk/feed#output-3)
```
{
  "qty": 75,
  "price": "130",
...
### [Equity order updates](https://groww.in/trade-api/docs/python-sdk/feed#equity-order-updates)
```
from growwapi import GrowwFeed, GrowwAPI
...
### [Output](https://groww.in/trade-api/docs/python-sdk/feed#output-4)
```
{
  "qty": 3,
  "filledQty": 3,
...
### [Order updates - Response Fields](https://groww.in/trade-api/docs/python-sdk/feed#order-updates---response-fields)
Name | Type | Description
---|---|---
...
## [Position Updates](https://groww.in/trade-api/docs/python-sdk/feed#position-updates)
Subscribe and get the latest updates on creation and execution of derivatives positions.
### [Derivatives position updates](https://groww.in/trade-api/docs/python-sdk/feed#derivatives-position-updates)
...
### [Output](https://groww.in/trade-api/docs/python-sdk/feed#output-5)
```
{
...
### [Position updates - Response Fields](https://groww.in/trade-api/docs/python-sdk/feed#position-updates---response-fields)
Name | Type | Description
---|---|---
...
## [Metadata](https://groww.in/trade-api/docs/python-sdk/feed#metadata)
...
### [Metadata Fields](https://groww.in/trade-api/docs/python-sdk/feed#metadata-fields)
Name | Type | Description
---|---|---
exchange | str | [Stock Exchange](https://groww.in/trade-api/docs/python-sdk/annexures#exchange)
segment | str |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
...
### [Example Metadata Usage](https://groww.in/trade-api/docs/python-sdk/feed#example-metadata-usage)
...
[Previous Backtesting](https://groww.in/trade-api/docs/python-sdk/backtesting)[Next User](https://groww.in/trade-api/docs/python-sdk/user)
[Feed Client](https://groww.in/trade-api/docs/python-sdk/feed#feed-client)[Feed Methods](https://groww.in/trade-api/docs/python-sdk/feed#feed-methods)[Live Data](https://groww.in/trade-api/docs/python-sdk/feed#live-data)[Indices Live Data](https://groww.in/trade-api/docs/python-sdk/feed#indices-live-data)[Market Depth](https://groww.in/trade-api/docs/python-sdk/feed#market-depth)[Order Updates](https://groww.in/trade-api/docs/python-sdk/feed#order-updates)[Position Updates](https://groww.in/trade-api/docs/python-sdk/feed#position-updates)[Metadata](https://groww.in/trade-api/docs/python-sdk/feed#metadata)
