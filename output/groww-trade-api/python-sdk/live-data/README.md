...
## [Get Quote](https://groww.in/trade-api/docs/python-sdk/live-data#get-quote)
Fetch a real-time quote for an individual instrument using this `get_quote` method.
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/live-data#python-sdk-usage)
```
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/live-data#request-schema)
...
`*`required parameters
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/live-data#response-payload)
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/live-data#response-schema)
Name | Type | Description
---|---|---
...
## [Get LTP](https://groww.in/trade-api/docs/python-sdk/live-data#get-ltp)
...
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/live-data#python-sdk-usage-1)
```
from growwapi import GrowwAPI
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/live-data#request-schema-1)
Name | Type | Description
---|---|---
segment `*` | string |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
...
`*`required parameters
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/live-data#response-payload-1)
All prices in rupees.
```
{
  "NSE_RELIANCE": 2500.5,
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/live-data#response-schema-1)
Name | Type | Description
---|---|---
ltp | float | Last traded price

## [Get OHLC](https://groww.in/trade-api/docs/python-sdk/live-data#get-ohlc)
...
Upto 50 instruments are supported for each function call.
Note: The OHLC data retrieved using the OHLC SDK method reflects the current time's OHLC (i.e., real-time snapshot). For interval-based OHLC data (e.g., 1-minute, 5-minute candles), please refer to the [Historical Data](https://groww.in/trade-api/docs/python-sdk/historical-data) SDK method.
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/live-data#python-sdk-usage-2)
```
from growwapi import GrowwAPI
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/live-data#request-schema-2)
Name | Type | Description
---|---|---
segment `*` | string |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
exchange_trading_symbols `*` | Tuple[str] | String of trading symbols with their respective exchanges
...
`*`required parameters
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/live-data#response-payload-2)
All prices in rupees.
```
{
  "NSE_NIFTY": {
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/live-data#response-schema-2)
Name | Type | Description
---|---|---
open | float | Opening price
...
## [Get Option Chain](https://groww.in/trade-api/docs/python-sdk/live-data#get-option-chain)
...
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/live-data#python-sdk-usage-3)
```
from growwapi import GrowwAPI
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/live-data#request-schema-3)
Name | Type | Description
---|---|---
exchange `*` | string |  [Stock exchange](https://groww.in/trade-api/docs/python-sdk/annexures#exchange) - NSE or BSE
...
`*`required parameters
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/live-data#response-payload-3)
All prices in rupees.
```
{
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/live-data#response-schema-3)
Name | Type | Description
---|---|---
underlying_ltp | float | Last traded price of the underlying instrument
...
## [Get Greeks](https://groww.in/trade-api/docs/python-sdk/live-data#get-greeks)
...
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/live-data#python-sdk-usage-4)
```
from growwapi import GrowwAPI
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/live-data#request-schema-4)
Name | Type | Description
---|---|---
exchange `*` | string |  [Stock exchange](https://groww.in/trade-api/docs/python-sdk/annexures#exchange) - NSE or BSE
...
`*`required parameters
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/live-data#response-payload-4)
```
{
  "greeks": {
    "delta": 0.6006,
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/live-data#response-schema-4)
Name | Type | Description
---|---|---
delta | float | Delta measures the rate of change of option price based on every 1 rupee change in the price of underlying.
...
[Previous Margin](https://groww.in/trade-api/docs/python-sdk/margin)[Next Historical Data](https://groww.in/trade-api/docs/python-sdk/historical-data)
[Get Quote](https://groww.in/trade-api/docs/python-sdk/live-data#get-quote)[Get LTP](https://groww.in/trade-api/docs/python-sdk/live-data#get-ltp)[Get OHLC](https://groww.in/trade-api/docs/python-sdk/live-data#get-ohlc)[Get Option Chain](https://groww.in/trade-api/docs/python-sdk/live-data#get-option-chain)[Get Greeks](https://groww.in/trade-api/docs/python-sdk/live-data#get-greeks)
