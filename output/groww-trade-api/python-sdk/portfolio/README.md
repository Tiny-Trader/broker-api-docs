...
## [Get Holdings](https://groww.in/trade-api/docs/python-sdk/portfolio#get-holdings)
...
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/portfolio#python-sdk-usage)
```
...
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/portfolio#response-payload)
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/portfolio#response-schema)
...
## [Get Positions for User](https://groww.in/trade-api/docs/python-sdk/portfolio#get-positions-for-user)
...
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/portfolio#python-sdk-usage-1)
```
from growwapi import GrowwAPI
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/portfolio#request-schema)
Name | Type | Description
---|---|---
segment | string |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
`*`required parameters
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/portfolio#response-payload-1)
All prices in rupees
```
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/portfolio#response-schema-1)
Name | Type | Description
---|---|---
...
## [Get Position for Symbol](https://groww.in/trade-api/docs/python-sdk/portfolio#get-position-for-symbol)
Retrieve detailed position information for a specific symbol using this `get_position_for_trading_symbol`.
### [Python SDK Usage](https://groww.in/trade-api/docs/python-sdk/portfolio#python-sdk-usage-2)
```
from growwapi import GrowwAPI
...
#### [Request Schema](https://groww.in/trade-api/docs/python-sdk/portfolio#request-schema-1)
Name | Type | Description
---|---|---
trading_symbol `*` | string | Trading symbol of the instrument.
...
segment `*` | string |  [Segment](https://groww.in/trade-api/docs/python-sdk/annexures#segment) of the instrument such as CASH, FNO etc.
`*`required parameter
### [Response Payload](https://groww.in/trade-api/docs/python-sdk/portfolio#response-payload-2)
All prices in rupees
```
{
  "positions": [
...
#### [Response Schema](https://groww.in/trade-api/docs/python-sdk/portfolio#response-schema-2)
Name | Type | Description
---|---|---
trading_symbol | string | Trading symbol of the instrument.
...
[Previous Smart Orders](https://groww.in/trade-api/docs/python-sdk/smart-orders)[Next Margin](https://groww.in/trade-api/docs/python-sdk/margin)
[Get Holdings](https://groww.in/trade-api/docs/python-sdk/portfolio#get-holdings)[Get Positions for User](https://groww.in/trade-api/docs/python-sdk/portfolio#get-positions-for-user)[Get Position for Symbol](https://groww.in/trade-api/docs/python-sdk/portfolio#get-position-for-symbol)
