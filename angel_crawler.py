"""
Angel One SmartAPI Documentation Crawler
Scrapes https://smartapi.angelbroking.com/docs and saves as structured markdown
"""
...
BASE_URL = "https://smartapi.angelbroking.com/docs"
...
def url_to_filepath(url: str) -> Path:
    ...
    if path.startswith("docs/"):
        path = path.replace("docs/", "", 1).strip("/")
...
async def main():
    """Entry point."""
    print(f"🕷️  Starting Angel One SmartAPI docs crawler")
